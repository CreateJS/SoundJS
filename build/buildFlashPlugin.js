...
var json = FILE.readFileSync(PATH.resolve("./configFlashPlugin.json"), "UTF-8");
json = JSON.parse(json);
var config =json.config_soundjs_flashplugin;
...
{	
	...
	CHILD_PROCESS.exec(
		...
		function(error, stdout, stderr)
		{
			...
			var license_data = FILE.readFileSync(__dirname + "/flashplugin-license.txt", "UTF-8");
...
{	
    ...
    if(type.indexOf("windows") != -1){  
		...
		zipCommand = "..\\tools\\7z a ..\\docs\\"+doc_file+" output > %temp%/7z-log.txt";
	} else {
