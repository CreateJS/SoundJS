...
b[c].id,b[c].data,b[c].preload);return a};a.removeSound=function(b){if(null==a.activePlugin)return!1;b instanceof Object&&(b=b.src);b=a.getSrcById(b);b=a.parsePath(b);if(null==b)return!1;b=b.src;for(var f in a.idHash)a.idHash[f]==b&&delete a.idHash[f];d.removeSrc(b);delete a.preloadHash[b];a.activePlugin.removeSound(b);return!0};a.removeManifest=function(b){for(var a=[],c=0,e=b.length;c<e;c++)a[c]=createjs.Sound.removeSound(b[c].src);return a};a.removeAllSounds=function(){a.idHash={};a.preloadHash=
...
this.tags.length},toString:function(){return"[HTMLAudioPlugin TagPool]"}}})();(function(){var a=this.createjs=this.createjs||{},a=a.SoundJS=a.SoundJS||{};a.version="NEXT";a.buildDate="Tue, 11 Jun 2013 16:05:24 GMT"})();
