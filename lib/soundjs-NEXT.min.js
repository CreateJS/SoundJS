...
function(a,c){var b=this._listeners;if(b){var e=b[a];if(e)for(var j=0,f=e.length;j<f;j++)if(e[j]==c){1==f?delete b[a]:e.splice(j,1);break}}};d.removeAllEventListeners=function(a){a?this._listeners&&delete this._listeners[a]:this._listeners=null};d.dispatchEvent=function(a,c){var b=!1,e=this._listeners;if(a&&e){"string"==typeof a&&(a={type:a});e=e[a.type];if(!e)return b;a.target=c||this;for(var e=e.slice(),j=0,f=e.length;j<f;j++)var g=e[j],b=g.handleEvent?b||g.handleEvent(a):b||g(a)}return!!b};d.hasEventListener=
...
this.interrupt=this.playFailed=this.pause=this.resume=this.play=this.beginPlaying=this.cleanUp=this.stop=this.setMasterVolume=this.setVolume=this.mute=this.setMute=this.getMute=this.setPan=this.getPosition=this.setPosition=function(){return!1};this.getVolume=this.getPan=this.getDuration=function(){return 0};this.playState=a.PLAY_FAILED;this.toString=function(){return"[Sound Default Sound Instance]"}};l.init=function(){var b=navigator.userAgent;l.isFirefox=-1<b.indexOf("Firefox");l.isOpera=null!=window.opera;
l.isChrome=-1<b.indexOf("Chrome");l.isIOS=-1<b.indexOf("iPod")||-1<b.indexOf("iPhone")||-1<b.indexOf("iPad");l.isAndroid=-1<b.indexOf("Android");l.isBlackberry=-1<b.indexOf("Blackberry")};l.init();createjs.Sound.BrowserDetect=l})();this.createjs=this.createjs||{};
...
new webkitAudioContext;else if(window.AudioContext)a.context=new AudioContext;else return null;a.playEmptySound();a.capabilities={panning:!0,volume:!0,tracks:-1};for(var b=createjs.Sound.SUPPORTED_EXTENSIONS,e=createjs.Sound.EXTENSION_MAP,d=0,f=b.length;d<f;d++){var g=b[d],k=e[g]||g;a.capabilities[g]="no"!=c.canPlayType("audio/"+g)&&""!=c.canPlayType("audio/"+g)||"no"!=c.canPlayType("audio/"+k)&&""!=c.canPlayType("audio/"+k)}2>a.context.destination.numberOfChannels&&(a.capabilities.panning=!1);a.dynamicsCompressorNode=
...
document.createElement("audio");if(null==b.canPlayType)return null;a.capabilities={panning:!0,volume:!0,tracks:-1};for(var c=createjs.Sound.SUPPORTED_EXTENSIONS,d=createjs.Sound.EXTENSION_MAP,f=0,g=c.length;f<g;f++){var k=c[f],h=d[k]||k;a.capabilities[k]="no"!=b.canPlayType("audio/"+k)&&""!=b.canPlayType("audio/"+k)||"no"!=b.canPlayType("audio/"+h)&&""!=b.canPlayType("audio/"+h)}}};a.prototype={capabilities:null,audioSources:null,defaultNumChannels:2,init:function(){this.capabilities=a.capabilities;
this.audioSources={}},register:function(a,e){this.audioSources[a]=!0;for(var d=c.get(a),f=null,g=e||this.defaultNumChannels,k=0;k<g;k++)f=this.createTag(a),d.add(f);return{tag:f,numChannels:g}},createTag:function(a){var c=document.createElement("audio");c.autoplay=!1;c.preload="none";c.src=a;return c},create:function(a){if(!this.isPreloadStarted(a)){var e=c.get(a),j=this.createTag(a);e.add(j);this.preload(a,{tag:j})}return new d(a,this)},isPreloadStarted:function(a){return null!=this.audioSources[a]},
preload:function(a,c){this.audioSources[a]=!0;new l(a,c.tag)},toString:function(){return"[HTMLAudioPlugin]"}};createjs.HTMLAudioPlugin=a;d.prototype={src:null,uniqueId:-1,playState:null,owner:null,loaded:!1,offset:0,delay:0,volume:1,pan:0,duration:0,remainingLoops:0,delayTimeoutId:null,tag:null,muted:!1,paused:!1,addEventListener:null,removeEventListener:null,removeAllEventListeners:null,dispatchEvent:null,hasEventListener:null,_listeners:null,onComplete:null,onLoop:null,onReady:null,onPlayFailed:null,
...
if(null!=a){a.pause();a.removeEventListener(createjs.HTMLAudioPlugin.AUDIO_ENDED,this.endedHandler,!1);a.removeEventListener(createjs.HTMLAudioPlugin.AUDIO_READY,this.readyHandler,!1);a.removeEventListener(createjs.HTMLAudioPlugin.AUDIO_SEEKED,this.loopHandler,!1);try{a.currentTime=0}catch(e){}c.setInstance(this.src,a);this.tag=null}clearTimeout(this.delayTimeoutId);null!=window.createjs&&createjs.Sound.playFinished(this)},interrupt:function(){if(null!=this.tag){this.playState=createjs.Sound.PLAY_INTERRUPTED;
if(this.onPlayInterrupted)this.onPlayInterrupted(this);this.cleanUp();this.paused=!1;this.sendEvent("interrupted")}},play:function(a,c,d,f,g,k){this.cleanUp();createjs.Sound.playInstance(this,a,c,d,f,g,k)},beginPlaying:function(a,e,d){if(null==window.createjs)return-1;var f=this.tag=c.getInstance(this.src);if(null==f)return this.playFailed(),-1;f.addEventListener(createjs.HTMLAudioPlugin.AUDIO_ENDED,this.endedHandler,!1);this.offset=a;this.volume=d;this.updateVolume();this.remainingLoops=e;4!==f.readyState?
...
this.sendEvent("failed")}},toString:function(){return"[HTMLAudioPlugin SoundInstance]"}};createjs.EventDispatcher.initialize(d.prototype);l.prototype={src:null,tag:null,preloadTimer:null,loadedHandler:null,init:function(a,c){this.src=a;this.tag=c;this.preloadTimer=setInterval(createjs.proxy(this.preloadTick,this),200);this.loadedHandler=createjs.proxy(this.sendLoadedEvent,this);this.tag.addEventListener&&this.tag.addEventListener("canplaythrough",this.loadedHandler);this.tag.onreadystatechange=createjs.proxy(this.sendLoadedEvent,
...
c.tags={};c.get=function(a){var d=c.tags[a];null==d&&(d=c.tags[a]=new c(a));return d};c.getInstance=function(a){a=c.tags[a];return null==a?null:a.get()};c.setInstance=function(a,d){var j=c.tags[a];return null==j?null:j.set(d)};c.prototype={src:null,length:0,available:0,tags:null,init:function(a){this.src=a;this.tags=[]},add:function(a){this.tags.push(a);this.length++;this.available++},get:function(){if(0==this.tags.length)return null;this.available=this.tags.length;var a=this.tags.pop();null==a.parentNode&&
document.body.appendChild(a);return a},set:function(a){-1==this.tags.indexOf(a)&&this.tags.push(a);this.available=this.tags.length},toString:function(){return"[HTMLAudioPlugin TagPool]"}}})();(function(){var a=this.createjs=this.createjs||{},a=a.SoundJS=a.SoundJS||{};a.version="NEXT";a.buildDate="Mon, 29 Apr 2013 17:26:13 GMT"})();
