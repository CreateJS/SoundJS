...
(function(){var a=function(){this.initialize()},e=a.prototype;a.initialize=function(a){a.addEventListener=e.addEventListener;a.removeEventListener=e.removeEventListener;a.removeAllEventListeners=e.removeAllEventListeners;a.hasEventListener=e.hasEventListener;a.dispatchEvent=e.dispatchEvent};e._listeners=null;e.initialize=function(){};e.addEventListener=function(a,b){var c=this._listeners;c||(c=this._listeners={});var d=c[a];d?this.removeEventListener(a,b):d=c[a]=[];d.push(b);return b};e.removeEventListener=
function(a,b){var c=this._listeners;if(c){var d=c[a];if(d)for(var g=0,f=d.length;g<f;g++)if(d[g]==b){1==f?delete c[a]:d.splice(g,1);break}}};e.removeAllEventListeners=function(a){a?this._listeners&&delete this._listeners[a]:this._listeners=null};e.dispatchEvent=function(a,b){var c=!1,d=this._listeners;if(a&&d){"string"==typeof a&&(a={type:a});a.target=b||this;d=d[a.type];if(!d)return c;for(var d=d.slice(),g=0,f=d.length;g<f;g++){var e=d[g];e instanceof Function?c=c||e.apply(null,[a]):e.handleEvent&&
(c=c||e.handleEvent(a))}}return!!c};e.hasEventListener=function(a){var b=this._listeners;return!(!b||!b[a])};e.toString=function(){return"[EventDispatcher]"};createjs.EventDispatcher=a})();this.createjs=this.createjs||{};
(function(){function a(){throw"Sound cannot be instantiated";}function e(b,c){this.init(b,c)}function k(){}a.DELIMITER="|";a.AUDIO_TIMEOUT=8E3;a.INTERRUPT_ANY="any";a.INTERRUPT_EARLY="early";a.INTERRUPT_LATE="late";a.INTERRUPT_NONE="none";a.PLAY_INITED="playInited";a.PLAY_SUCCEEDED="playSucceeded";a.PLAY_INTERRUPTED="playInterrupted";a.PLAY_FINISHED="playFinished";a.PLAY_FAILED="playFailed";a.SUPPORTED_EXTENSIONS="mp3 ogg mpeg wav m4a mp4 aiff wma mid".split(" ");a.EXTENSION_MAP={m4a:"mp4"};a.FILE_PATTERN=
...
function(b){var c=a.preloadHash[b],c={target:this,type:"loadComplete",src:c.src,id:c.id,data:c.data};a.preloadHash[b]=!0;a.onLoadComplete&&a.onLoadComplete(c);a.dispatchEvent(c)};a.getPreloadHandlers=function(){return{callback:createjs.proxy(a.initLoad,a),types:["sound"],extensions:a.SUPPORTED_EXTENSIONS}};a.registerPlugin=function(b){a.pluginsRegistered=!0;return null==b?!1:b.isSupported()?(a.activePlugin=new b,!0):!1};a.registerPlugins=function(b){for(var c=0,d=b.length;c<d;c++)if(a.registerPlugin(b[c]))return!0;
return!1};a.initializeDefaultPlugins=function(){return null!=a.activePlugin?!0:a.pluginsRegistered?!1:a.registerPlugins([createjs.WebAudioPlugin,createjs.HTMLAudioPlugin])?!0:!1};a.isReady=function(){return null!=a.activePlugin};a.getCapabilities=function(){return null==a.activePlugin?null:a.activePlugin.capabilities};a.getCapability=function(b){return null==a.activePlugin?null:a.activePlugin.capabilities[b]};a.initLoad=function(b,c,d,g){b=a.registerSound(b,d,g,!1);return null==b?!1:b};a.registerSound=
function(b,c,d,g){if(!a.initializeDefaultPlugins())return!1;b instanceof Object&&(b=b.src,c=b.id,d=b.data);var f=a.parsePath(b,"sound",c,d);if(null==f)return!1;null!=c&&(a.idHash[c]=f.src);var j=null;null!=d&&(isNaN(d.channels)?isNaN(d)||(j=parseInt(d)):j=parseInt(d.channels));var h=a.activePlugin.register(f.src,j);null!=h&&(null!=h.numChannels&&(j=h.numChannels),e.create(f.src,j),null!=h.tag?f.tag=h.tag:h.src&&(f.src=h.src),null!=h.completeHandler&&(f.completeHandler=h.completeHandler),f.type=h.type);
!1!=g&&(a.preloadHash[f.src]={src:b,id:c,data:d},a.activePlugin.preload(f.src,h));return f};a.registerManifest=function(b){for(var c=[],a=0,g=b.length;a<g;a++)c[a]=createjs.Sound.registerSound(b[a].src,b[a].id,b[a].data,b[a].preload);return c};a.loadComplete=function(b){var c=a.parsePath(b,"sound");b=c?a.getSrcById(c.src):a.getSrcById(b);return!0==a.preloadHash[b]};a.parsePath=function(b,c,d,g){b=b.split(a.DELIMITER);c={type:c||"sound",id:d,data:g};d=a.getCapabilities();g=0;for(var f=b.length;g<f;g++){var e=
b[g],h=e.match(a.FILE_PATTERN);if(null==h)return!1;var k=h[4],h=h[5];if(d[h]&&-1<a.SUPPORTED_EXTENSIONS.indexOf(h))return c.name=k,c.src=e,c.extension=h,c}return null};a.play=function(b,c,d,g,f,e,h){b=a.createInstance(b);a.playInstance(b,c,d,g,f,e,h)||b.playFailed();return b};a.createInstance=function(b){if(!a.initializeDefaultPlugins())return a.defaultSoundInstance;var c=a.parsePath(b,"sound");b=c?a.getSrcById(c.src):a.getSrcById(b);var c=b.lastIndexOf("."),d=b.slice(c+1);-1!=c&&-1<a.SUPPORTED_EXTENSIONS.indexOf(d)?
(e.create(b),b=a.activePlugin.create(b)):b=a.defaultSoundInstance;b.uniqueId=a.lastId++;return b};a.setVolume=function(b){if(null==Number(b))return!1;b=Math.max(0,Math.min(1,b));a.masterVolume=b;if(!this.activePlugin||!this.activePlugin.setVolume||!this.activePlugin.setVolume(b))for(var c=0,d=this.instances.length;c<d;c++)this.instances[c].setMasterVolume(b)};a.getVolume=function(){return a.masterVolume};a.mute=function(b){this.masterMute=b;if(!this.activePlugin||!this.activePlugin.setMute||!this.activePlugin.setMute(b))for(var a=
0,d=this.instances.length;a<d;a++)this.instances[a].setMasterMute(b)};a.setMute=function(b){if(null==b||void 0==b)return!1;this.masterMute=b;if(!this.activePlugin||!this.activePlugin.setMute||!this.activePlugin.setMute(b))for(var a=0,d=this.instances.length;a<d;a++)this.instances[a].setMasterMute(b);return!0};a.getMute=function(){return this.masterMute};a.stop=function(){for(var b=this.instances.length;0<b;b--)this.instances[b-1].stop()};a.playInstance=function(b,c,d,g,f,e,h){c=c||a.defaultInterruptBehavior;
null==d&&(d=0);null==g&&(g=b.getPosition());null==f&&(f=0);null==e&&(e=b.getVolume());null==h&&(h=b.getPan());if(0==d){if(!a.beginPlaying(b,c,g,f,e,h))return!1}else d=setTimeout(function(){a.beginPlaying(b,c,g,f,e,h)},d),b.delayTimeoutId=d;this.instances.push(b);return!0};a.beginPlaying=function(b,a,d,g,f,j){return!e.add(b,a)?!1:!b.beginPlaying(d,g,f,j)?(b=this.instances.indexOf(b),-1<b&&this.instances.splice(b,1),!1):!0};a.getSrcById=function(b){return null==a.idHash||null==a.idHash[b]?b:a.idHash[b]};
a.playFinished=function(b){e.remove(b);b=this.instances.indexOf(b);-1<b&&this.instances.splice(b,1)};a.proxy=function(b,a){return function(){return b.apply(a,arguments)}};createjs.Sound=a;createjs.proxy=function(b,a){var d=Array.prototype.slice.call(arguments,2);return function(){return b.apply(a,Array.prototype.slice.call(arguments,0).concat(d))}};e.channels={};e.create=function(b,a){return null==e.get(b)?(e.channels[b]=new e(b,a),!0):!1};e.add=function(b,a){var d=e.get(b.src);return null==d?!1:
d.add(b,a)};e.remove=function(b){var a=e.get(b.src);if(null==a)return!1;a.remove(b);return!0};e.get=function(b){return e.channels[b]};e.prototype={src:null,max:null,maxDefault:100,length:0,init:function(b,a){this.src=b;this.max=a||this.maxDefault;-1==this.max&&this.max==this.maxDefault;this.instances=[]},get:function(b){return this.instances[b]},add:function(b,a){if(!this.getSlot(a,b))return!1;this.instances.push(b);this.length++;return!0},remove:function(b){b=this.instances.indexOf(b);if(-1==b)return!1;
this.instances.splice(b,1);this.length--;return!0},getSlot:function(b){for(var c,d,g=0,e=this.max;g<e;g++){c=this.get(g);if(null==c)return!0;if(!(b==a.INTERRUPT_NONE&&c.playState!=a.PLAY_FINISHED))if(0==g)d=c;else if(c.playState==a.PLAY_FINISHED||c==a.PLAY_INTERRUPTED||c==a.PLAY_FAILED)d=c;else if(b==a.INTERRUPT_EARLY&&c.getPosition()<d.getPosition()||b==a.INTERRUPT_LATE&&c.getPosition()>d.getPosition())d=c}return null!=d?(d.interrupt(),this.remove(d),!0):!1},toString:function(){return"[Sound SoundChannel]"}};
a.defaultSoundInstance=new function(){this.isDefault=!0;this.addEventListener=this.removeEventListener=this.removeAllEventListener=this.dispatchEvent=this.hasEventListener=this._listeners=this.interrupt=this.playFailed=this.pause=this.resume=this.play=this.beginPlaying=this.cleanUp=this.stop=this.setMasterVolume=this.setVolume=this.mute=this.setMute=this.getMute=this.setPan=this.getPosition=this.setPosition=function(){return!1};this.getVolume=this.getPan=this.getDuration=function(){return 0};this.playState=
a.PLAY_FAILED;this.toString=function(){return"[Sound Default Sound Instance]"}};k.init=function(){var b=navigator.userAgent;k.isFirefox=-1<b.indexOf("Firefox");k.isOpera=null!=window.opera;k.isChrome=-1<b.indexOf("Chrome");k.isIOS=-1<b.indexOf("iPod")||-1<b.indexOf("iPhone")||-1<b.indexOf("iPad")};k.init();createjs.Sound.BrowserDetect=k})();this.createjs=this.createjs||{};
(function(){function a(){this.init()}function e(b,a){this.init(b,a)}function k(b,a){this.init(b,a)}a.capabilities=null;a.isSupported=function(){a.generateCapabilities();return null==a.context?!1:!0};a.generateCapabilities=function(){if(null==a.capabilities){var b=document.createElement("audio");if(null==b.canPlayType)return null;if(window.webkitAudioContext)a.context=new webkitAudioContext;else if(window.AudioContext)a.context=new AudioContext;else return null;a.capabilities={panning:!0,volume:!0,
tracks:-1};for(var c=0,d=createjs.Sound.SUPPORTED_EXTENSIONS.length;c<d;c++){var g=createjs.Sound.SUPPORTED_EXTENSIONS[c],e=createjs.Sound.EXTENSION_MAP[g]||g;a.capabilities[g]="no"!=b.canPlayType("audio/"+g)&&""!=b.canPlayType("audio/"+g)||"no"!=b.canPlayType("audio/"+e)&&""!=b.canPlayType("audio/"+e)}2>a.context.destination.numberOfChannels&&(a.capabilities.panning=!1);a.dynamicsCompressorNode=a.context.createDynamicsCompressor();a.dynamicsCompressorNode.connect(a.context.destination);a.gainNode=
a.context.createGainNode();a.gainNode.connect(a.dynamicsCompressorNode)}};a.prototype={capabilities:null,volume:1,context:null,dynamicsCompressorNode:null,gainNode:null,arrayBuffers:null,init:function(){this.capabilities=a.capabilities;this.arrayBuffers={};this.context=a.context;this.gainNode=a.gainNode;this.dynamicsCompressorNode=a.dynamicsCompressorNode},register:function(b){this.arrayBuffers[b]=!0;return{tag:new k(b,this)}},isPreloadStarted:function(b){return null!=this.arrayBuffers[b]},isPreloadComplete:function(b){return!(null==
this.arrayBuffers[b]||!0==this.arrayBuffers[b])},removeFromPreload:function(b){delete this.arrayBuffers[b]},addPreloadResults:function(b,a){this.arrayBuffers[b]=a},handlePreloadComplete:function(){createjs.Sound.sendLoadComplete(this.src)},preload:function(a){this.arrayBuffers[a]=!0;a=new k(a,this);a.onload=this.handlePreloadComplete;a.load()},create:function(a){this.isPreloadStarted(a)||this.preload(a);return new e(a,this)},setVolume:function(a){this.volume=a;this.updateVolume();return!0},updateVolume:function(){var a=
...
this.offset,this.sourceNode.noteGrainOn(0,this.offset,this.sourceNode.buffer.duration-this.offset)))},play:function(a,c,d,e,f,j){this.cleanUp();createjs.Sound.playInstance(this,a,c,d,e,f,j)},beginPlaying:function(a,c,d,e){if(null!=window.createjs&&this.src){this.offset=a/1E3;this.remainingLoops=c;this.setVolume(d);this.setPan(e);if(this.owner.isPreloadComplete(this.src))return this.handleSoundReady(null),this.onPlaySucceeded&&this.onPlaySucceeded(this),this.sendEvent("succeeded"),1;this.playFailed()}},
...
this.cleanUp()}},toString:function(){return"[WebAudioPlugin SoundInstance]"}};createjs.EventDispatcher.initialize(e.prototype);k.prototype={request:null,owner:null,progress:-1,src:null,result:null,onload:null,onprogress:null,onError:null,init:function(a,c){this.src=a;this.owner=c},load:function(a){null!=a&&(this.src=a);this.request=new XMLHttpRequest;this.request.open("GET",this.src,!0);this.request.responseType="arraybuffer";this.request.onload=createjs.proxy(this.handleLoad,this);this.request.onError=
createjs.proxy(this.handleError,this);this.request.onprogress=createjs.proxy(this.handleProgress,this);this.request.send()},handleProgress:function(a,c){this.progress=a/c;if(null!=this.onprogress)this.onprogress({loaded:a,total:c,progress:this.progress})},handleLoad:function(){a.context.decodeAudioData(this.request.response,createjs.proxy(this.handleAudioDecoded,this),createjs.proxy(this.handleError,this))},handleAudioDecoded:function(a){this.progress=1;this.result=a;this.owner.addPreloadResults(this.src,
...
if(null==b.canPlayType)return null;a.capabilities={panning:!0,volume:!0,tracks:-1};for(var d=0,e=createjs.Sound.SUPPORTED_EXTENSIONS.length;d<e;d++){var f=createjs.Sound.SUPPORTED_EXTENSIONS[d],j=createjs.Sound.EXTENSION_MAP[f]||f;a.capabilities[f]="no"!=b.canPlayType("audio/"+f)&&""!=b.canPlayType("audio/"+f)||"no"!=b.canPlayType("audio/"+j)&&""!=b.canPlayType("audio/"+j)}}};a.prototype={capabilities:null,audioSources:null,defaultNumChannels:2,init:function(){this.capabilities=a.capabilities;this.audioSources=
{}},register:function(a,d){this.audioSources[a]=!0;for(var e=b.get(a),f,j=d||this.defaultNumChannels,h=0;h<j;h++)f=this.createTag(a),e.add(f);return{tag:f,numChannels:j}},createTag:function(a){var b=document.createElement("audio");b.preload=!1;b.src=a;return b},create:function(a){if(!this.isPreloadStarted(a)){var d=b.get(a),g=this.createTag(a);d.add(g);this.preload(a,{tag:g})}return new e(a,this)},isPreloadStarted:function(a){return null!=this.audioSources[a]},preload:function(a,b){this.audioSources[a]=
!0;new k(a,b.tag)},toString:function(){return"[HTMLAudioPlugin]"}};createjs.HTMLAudioPlugin=a;e.prototype={src:null,uniqueId:-1,playState:null,owner:null,loaded:!1,offset:0,delay:0,volume:1,pan:0,duration:0,remainingLoops:0,delayTimeoutId:null,tag:null,muted:!1,paused:!1,addEventListener:null,removeEventListener:null,removeAllEventListeners:null,dispatchEvent:null,hasEventListener:null,_listeners:null,onComplete:null,onLoop:null,onReady:null,onPlayFailed:null,onPlayInterrupted:null,onPlaySucceeded:null,
endedHandler:null,readyHandler:null,stalledHandler:null,init:function(a,b){this.src=a;this.owner=b;this.endedHandler=createjs.proxy(this.handleSoundComplete,this);this.readyHandler=createjs.proxy(this.handleSoundReady,this);this.stalledHandler=createjs.proxy(this.handleSoundStalled,this)},sendEvent:function(a){this.dispatchEvent({target:this,type:a})},cleanUp:function(){var a=this.tag;if(null!=a){a.pause();try{a.currentTime=0}catch(d){}a.removeEventListener(createjs.HTMLAudioPlugin.AUDIO_ENDED,this.endedHandler,
!1);a.removeEventListener(createjs.HTMLAudioPlugin.AUDIO_READY,this.readyHandler,!1);b.setInstance(this.src,a);this.tag=null}clearTimeout(this.delayTimeoutId);null!=window.createjs&&createjs.Sound.playFinished(this)},interrupt:function(){if(null!=this.tag){this.playState=createjs.Sound.PLAY_INTERRUPTED;if(this.onPlayInterrupted)this.onPlayInterrupted(this);this.sendEvent("interrupted");this.cleanUp();this.paused=!1}},play:function(a,b,e,f,j,h){this.cleanUp();createjs.Sound.playInstance(this,a,b,e,
f,j,h)},beginPlaying:function(a,d,e){if(null==window.createjs)return-1;var f=this.tag=b.getInstance(this.src);if(null==f)return this.playFailed(),-1;this.duration=1E3*this.tag.duration;f.addEventListener(createjs.HTMLAudioPlugin.AUDIO_ENDED,this.endedHandler,!1);this.offset=a;this.volume=e;this.updateVolume();this.remainingLoops=d;4!==f.readyState?(f.addEventListener(createjs.HTMLAudioPlugin.AUDIO_READY,this.readyHandler,!1),f.addEventListener(createjs.HTMLAudioPlugin.AUDIO_STALLED,this.stalledHandler,
...
k.prototype={src:null,tag:null,preloadTimer:null,loadedHandler:null,init:function(a,b){this.src=a;this.tag=b;this.preloadTimer=setInterval(createjs.proxy(this.preloadTick,this),200);this.loadedHandler=createjs.proxy(this.sendLoadedEvent,this);this.tag.addEventListener&&this.tag.addEventListener("canplaythrough",this.loadedHandler);this.tag.onreadystatechange=createjs.proxy(this.sendLoadedEvent,this);this.tag.preload="auto";this.tag.src=a;this.tag.load()},preloadTick:function(){var a=this.tag.buffered,
b=this.tag.duration;0<a.length&&a.end(0)>=b-1&&this.handleTagLoaded()},handleTagLoaded:function(){clearInterval(this.preloadTimer)},sendLoadedEvent:function(){this.tag.removeEventListener&&this.tag.removeEventListener("canplaythrough",this.loadedHandler);this.tag.onreadystatechange=null;createjs.Sound.sendLoadComplete(this.src)},toString:function(){return"[HTMLAudioPlugin HTMLAudioLoader]"}};b.tags={};b.get=function(a){var d=b.tags[a];null==d&&(d=b.tags[a]=new b(a));return d};b.getInstance=function(a){a=
b.tags[a];return null==a?null:a.get()};b.setInstance=function(a,d){var e=b.tags[a];return null==e?null:e.set(d)};b.prototype={src:null,length:0,available:0,tags:null,init:function(a){this.src=a;this.tags=[]},add:function(a){this.tags.push(a);this.length++;this.available++},get:function(){if(0==this.tags.length)return null;this.available=this.tags.length;var a=this.tags.pop();null==a.parentNode&&document.body.appendChild(a);return a},set:function(a){-1==this.tags.indexOf(a)&&this.tags.push(a);this.available=
this.tags.length},toString:function(){return"[HTMLAudioPlugin TagPool]"}}})();(function(){var a=this.createjs=this.createjs||{},a=a.SoundJS=a.SoundJS||{};a.version="NEXT";a.buildDate="Mon, 14 Jan 2013 21:07:17 GMT"})();
