...
**/(function(){var c=this.createjs=this.createjs||{},c=c.PreloadJS=c.PreloadJS||{};c.version="0.3.0";c.buildDate="Tue, 05 Feb 2013 16:48:33 GMT"})();this.createjs=this.createjs||{};
...
new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(e){try{f=new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(j){try{f=new ActiveXObject("Msxml2.XMLHTTP")}catch(h){return false}}}a.type==createjs.LoadQueue.TEXT&&f.overrideMimeType&&f.overrideMimeType("text/plain; charset=x-user-defined");this._xhrLevel=typeof f.responseType==="string"?2:1;f.open("GET",a.src,true);b&&f instanceof XMLHttpRequest&&this._xhrLevel==1&&f.setRequestHeader("Origin",location.origin);if(createjs.LoadQueue.isBinary(a.type))f.responseType=
"arraybuffer";this._request=f;return true};a._clean=function(){clearTimeout(this._loadTimeout);var a=this._request;a.onloadstart=null;a.onprogress=null;a.onabort=null;a.onerror=null;a.onload=null;a.ontimeout=null;a.onloadend=null;a.onreadystatechange=null};a._generateTag=function(){var a=this._item.tag;switch(this._item.type){case createjs.LoadQueue.IMAGE:return a.onload=createjs.proxy(this._handleTagReady,this),a.src=this._item.src,this._rawResponse=this._response,this._response=a,false;case createjs.LoadQueue.JAVASCRIPT:a=
