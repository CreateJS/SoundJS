 ...
 * grouped into a single file. We recommend at least 300ms of silence between audio clips to deal with some HTML audio
 * tag inaccuracy issues, and to prevent accidentally playing bits of the neighbouring clips.
 *
 ...
 * as well as a <a href="http://jsfiddle.net/bharat_battu/g8fFP/12/" target="_blank">jsfiddle</a> to convert the output to SoundJS format.
 *
 * @class AudioSprite
 * @since 0.6.0
 */
